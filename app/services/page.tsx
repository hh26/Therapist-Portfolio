...
import { Heart, Users, User, CreditCard, GraduationCap } from 'lucide-react';
    ...
    <div className="bg-white py-16 md:py-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto">Specialized, 1-on-1 online therapeutic approaches designed to help you overcome obstacles from the comfort of your own space.</p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-[#FAFAFA] p-8 rounded-3xl border border-slate-100 flex flex-col justify-center">
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-between items-center border-b border-slate-200 pb-4">
                  <div>
                    <p className="font-medium text-slate-900">Couples Counseling</p>
                    <p className="text-sm text-slate-500 mt-0.5">60-minute video session</p>
                  </div>
                  <p className="text-xl font-semibold text-emerald-700">₹1,200</p>
                </div>
